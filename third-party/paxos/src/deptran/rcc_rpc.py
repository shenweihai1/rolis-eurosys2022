...
class MultiPaxosService(object):
    ...
    ACCEPT = 0x45be4f9a
    DECIDE = 0x595dcad1
    HEARTBEAT = 0x6b179d92
    BULKPREPARE = 0x641fee56
    BULKACCEPT = 0x264c7e37
    BULKPREPARE2 = 0x320941b0
    SYNCLOG = 0x52978999
    SYNCCOMMIT = 0x30ef1404
    SYNCNOOPS = 0x254cb12d
    BULKDECIDE = 0x2cc1cda1
...
class ClassicService(object):
    MSGSTRING = 0x17510e7e
    MSGMARSHALL = 0x130f85a8
    DISPATCH = 0x4ea532c2
    PREPARE = 0x43326929
    COMMIT = 0x6f73f717
    ABORT = 0x478bd886
    UPGRADEEPOCH = 0x5446f321
    TRUNCATEEPOCH = 0x1aa06f6b
    RPC_NULL = 0x560c50a0
    TAPIRACCEPT = 0x4c8c0532
    TAPIRFASTACCEPT = 0x1a464cc3
    TAPIRDECIDE = 0x613a5dea
    RCCDISPATCH = 0x1c3a453d
    RCCFINISH = 0x35d82200
    RCCINQUIRE = 0x623857f9
    RCCDISPATCHRO = 0x25585f6c
    RCCINQUIREVALIDATION = 0x55f97ffc
    RCCNOTIFYGLOBALVALIDATION = 0x4a07a944
    JANUSDISPATCH = 0x1f74b66f
    JANUSCOMMIT = 0x25c51688
    JANUSCOMMITWOGRAPH = 0x48e3540a
    JANUSINQUIRE = 0x49b57d90
    JANUSPREACCEPT = 0x4a717b91
    JANUSPREACCEPTWOGRAPH = 0x4db18b06
    JANUSACCEPT = 0x26daf94e
    PREACCEPTFEBRUUS = 0x26ea7488
    ACCEPTFEBRUUS = 0x14978de5
    COMMITFEBRUUS = 0x5ce5c1c1
...
class ServerControlService(object):
    SERVER_SHUTDOWN = 0x1cbb01b4
    SERVER_READY = 0x595c25c1
    SERVER_HEART_BEAT_WITH_DATA = 0x68facf3b
    SERVER_HEART_BEAT = 0x367a49f4
...
class ClientControlService(object):
    CLIENT_GET_TXN_NAMES = 0x6cdac095
    CLIENT_SHUTDOWN = 0x68fd0794
    CLIENT_FORCE_STOP = 0x3982efcd
    CLIENT_RESPONSE = 0x34ab016a
    CLIENT_READY = 0x3cb23e66
    CLIENT_READY_BLOCK = 0x1cdb1fa5
    CLIENT_START = 0x135557bb
    DISPATCHTXN = 0x316847d9
