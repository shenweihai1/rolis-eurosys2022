...
"""
purpose:
  monitor CPU and mem usage per [duration] second

usage:
  python3 mem_monitor.py -o [outputfile] -d [duration] -n [numa-required], i.e., python3 mem_monitor.py -o m.log -d 0.5 -n 1
...
if __name__ == "__main__":
    ...
    try:
        opts, args = getopt.getopt(argv,"hd:o:n:", ["duration=", "ofile=", "numa="])
    except getopt.GetoptError:
        print('python3 mem_monitor.py -o [outputfile] -d [duration]')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('python3 mem_monitor.py -o [outputfile] -d [duration]')
